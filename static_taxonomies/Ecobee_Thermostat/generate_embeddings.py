...
with open(C.siamese_embeddings_paths['train'], "wb") as f:
    pickle.dump(train_embeds, f)

with open(C.siamese_embeddings_paths['validation'], "wb") as f:
    pickle.dump(calibration_embeds, f)

with open(C.siamese_embeddings_paths['test'], "wb") as f:
