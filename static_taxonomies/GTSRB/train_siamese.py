...
input_a = Input(shape=(C.input_side_size, C.input_side_size, 3))
input_b = Input(shape=(C.input_side_size, C.input_side_size, 3))
...
siamese_network.compile(loss=helper.euclidean_loss, optimizer=keras.optimizers.adam())
